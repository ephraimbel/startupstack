-- RenewalRadar Seed Data (idea_006)
-- Contract renewal management and tracking
...
INSERT INTO ideas (
  ...
  'Tiered subscription: Starter $49/month (25 contracts), Growth $149/month (100 contracts), Business $349/month (unlimited contracts). 14-day free trial with full features.',
  ARRAY['contract-management', 'procurement', 'saas', 'b2b-tools', 'renewal-tracking'],
  NULL,
  'validated',
  94,
  'high',
  ...
  NOW(),
  NOW(),
  'Perfect storm: (1) Average company now uses 100+ SaaS tools—tracking is impossible manually, (2) Subscription fatigue is real—nobody knows what they''re paying for, (3) AI can now extract terms from contracts accurately, (4) Economic pressure means companies are auditing spend more carefully, (5) Auto-renewal is now the default—vendors count on you forgetting.',
  'Stop wasting money on forgotten renewals. Negotiate from a position of strength. Save $20K+ annually on avoided auto-renewals. Reduce contract management time by 80%.',
  '$8B',
  'Medium',
  'business-tools',
  'b2b',
...
-- Insert landing page for RenewalRadar
...
-- Insert execution plan with comprehensive RenewalRadar deliverable content

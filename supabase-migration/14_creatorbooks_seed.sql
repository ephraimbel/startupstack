-- CreatorBooks Seed Data (idea_004)
-- Financial dashboard for creator business management
...
INSERT INTO ideas (
  ...
  'Freemium: Free (2 platforms, basic tracking), Pro $19/month (unlimited platforms, tax estimates, bank connections), Business $49/month (multiple entities, accountant access), Agency $149/month (unlimited creators).',
  ARRAY['creator-tools', 'financial-management', 'accounting', 'saas', 'tax-software'],
  NULL,
  'validated',
  92,
  'high',
  ...
  NOW(),
  NOW(),
  'Perfect storm: (1) Creator economy hit $250B in 2024—millions now earn real income across platforms, (2) IRS is cracking down on gig economy reporting with new 1099-K thresholds, (3) Traditional accounting software (QuickBooks) doesn''t understand creator revenue streams, (4) Creator burnout is real—financial stress compounds creative stress.',
  'Know exactly what you owe in taxes. Track every dollar automatically. See which platforms are worth your time. Reduce financial stress so you can focus on creating.',
  '$50B',
  'Medium',
  'financial-tools',
  'b2c',
...
-- Insert landing page for CreatorBooks
...
-- Insert execution plan with comprehensive CreatorBooks deliverable content
  ...
  ARRAY[
    ...
    '{
      "core_features": [
        ...
        {
          "feature": "Tax Document Organizer",
          "description": "Store 1099s as they arrive. Checklist of expected forms based on connected platforms. Year-end tax package export.",
          "priority": "P1",
          "effort": "Small"
        },
        {
          "feature": "Creator Metrics",
          "description": "Revenue per subscriber (Patreon, YouTube members). Effective hourly rate (income ÷ content hours logged). Platform diversification score.",
          "priority": "P1",
          "effort": "Medium"
        },
        {
          "feature": "Deduction Suggestions",
          "description": "AI surfaces potential deductions based on spending patterns: home office, equipment, software subscriptions, travel to events.",
          "priority": "P1",
          "effort": "Medium"
        },
        {
          "feature": "Financial Health Score",
          "description": "Simple score (0-100) based on income diversity, expense ratio, tax preparedness, and savings rate. Actionable tips to improve.",
          "priority": "P1",
          "effort": "Small"
        }
      ],
    ...
    '{
      ...
      "build_vs_buy": [
        ...
        {
          "component": "Reporting/Charts",
          "recommendation": "Build (with Tremor/Recharts)",
          "reasoning": "Use a charting library but build custom dashboard UX for creators."
        },
        {
  ...
  ARRAY[
    ...
    '{
      ...
      "problem_section": {
        ...
        "pain_points": [
          {
            "pain": "12 dashboards, 12 headaches",
            "detail": "YouTube AdSense, Patreon, Gumroad, Stripe, brand deals, affiliates... Each platform has different payouts, different reports, different tax forms. Good luck tracking it all."
          },
          {
            "pain": "Tax time is a nightmare",
            "detail": "Scrambling to download CSVs, find 1099s, and remember that brand deal from March. You either overpay because you missed deductions, or underpay and worry about audits."
          },
          {
            "pain": "No idea if you''re actually profitable",
            "detail": "Revenue is up, but so are expenses. Is your creator business actually working? What''s your effective hourly rate? Which platform should you focus on?"
          }
        ]
      },
      "solution_section": {
        ...
        "features": [
          {
            "title": "Auto-Import Income",
            "description": "Connect YouTube, Patreon, Gumroad, Stripe, and more. Every dollar imported automatically.",
            "icon_suggestion": "Download/sync icon"
          },
          {
            "title": "Real-Time Tax Estimates",
            "description": "Know your quarterly tax obligation today. Federal and state. No April surprises.",
            "icon_suggestion": "Calculator/percentage icon"
          },
          {
            "title": "Expense Tracking",
            "description": "Connect your bank or snap receipts. AI categorizes everything. See what''s deductible.",
            "icon_suggestion": "Receipt/camera icon"
          },
          {
            "title": "Brand Deal Tracker",
            "description": "Log sponsorships, track payment status, see brand deal income separately.",
            "icon_suggestion": "Handshake/deal icon"
          },
          {
            "title": "Creator Metrics",
            "description": "Revenue per subscriber. Effective hourly rate. Platform diversification. Metrics that actually matter.",
            "icon_suggestion": "Chart/trending icon"
          },
          {
            "title": "Tax-Ready Reports",
            "description": "P&L reports, 1099 organizer, deduction summaries. Export everything for your accountant.",
            "icon_suggestion": "Document/export icon"
          }
        ]
      },
      "how_it_works": {
      ...
      "social_proof": {
        ...
        "testimonial_placeholders": [
          "Full-time YouTuber who discovered $8K in missed deductions",
          "Patreon creator who avoided a tax penalty with quarterly estimates",
          "Multi-platform creator who finally knows their effective hourly rate"
        ],
        "stats_to_display": [
          "$XXM creator income tracked",
          "XX,XXX creators using CreatorBooks",
          "Average $X,XXX saved in taxes per creator",
          "XX platforms connected"
        ]
      },
      "pricing_section": {
        "headline": "Costs less than one hour with a CPA",
      ...
      "meta": {
        "page_title": "CreatorBooks — Financial Dashboard for YouTubers, Streamers & Creators",
        "meta_description": "Track income from YouTube, Patreon, Gumroad, and brand deals in one dashboard. Real-time tax estimates, expense tracking, and creator metrics. Free to start."
      }
    }',
    ...
    '{
      "pre_launch": {
        "4_weeks_before": [
          {"task": "MVP with YouTube, Patreon, Gumroad integrations", "category": "Product", "critical": true},
          {"task": "Revenue dashboard with basic charts", "category": "Product", "critical": true},
          {"task": "Manual expense entry with categories", "category": "Product", "critical": true},
          ...
          {"task": "Start Twitter/YouTube content on creator finances", "category": "Marketing", "critical": false}
        ],
        "2_weeks_before": [
          {"task": "Add Plaid for bank connections", "category": "Product", "critical": true},
          {"task": "Tax estimate calculator (federal + major states)", "category": "Product", "critical": true},
          {"task": "Receipt scanning with AI categorization", "category": "Product", "critical": false},
          {"task": "Beta test with 30-50 creators", "category": "Product", "critical": true},
          {"task": "Collect testimonials and case studies", "category": "Marketing", "critical": true},
        ...
        "1_week_before": [
          ...
          {"task": "Reach out to creator finance newsletters/podcasts", "category": "Marketing", "critical": false},
          {"task": "Prepare launch day social content", "category": "Marketing", "critical": true},
          {"task": "Brief support on common questions", "category": "Support", "critical": true}
        ],
        "day_before": [
          ...
          {"task": "Test all integrations one more time", "category": "Product", "critical": true},
          {"task": "Rest up", "category": "Personal", "critical": true}
        ]
      },
      "launch_day": [
        {"time": "12:01 AM PT", "task": "Product Hunt goes live", "platform": "Product Hunt"},
        {"time": "6:00 AM", "task": "Maker comment with personal creator finance horror story", "platform": "Product Hunt"},
        {"time": "7:00 AM", "task": "Twitter thread: ''I tracked 127 creators'' finances. Here''s what I learned.''", "platform": "Twitter/X"},
        {"time": "8:00 AM", "task": "LinkedIn post targeting creator economy professionals", "platform": "LinkedIn"},
        {"time": "9:00 AM", "task": "Send launch email to waitlist", "platform": "Email"},
        {"time": "10:00 AM", "task": "Post in creator communities (Patreon Discord, YouTube subreddits)", "platform": "Reddit/Discord"},
        {"time": "12:00 PM", "task": "YouTube Shorts / TikTok showing the dashboard", "platform": "YouTube/TikTok"},
        {"time": "All day", "task": "Reply to every PH comment", "platform": "Product Hunt"},
        {"time": "All day", "task": "Monitor for bugs, especially integrations", "platform": "Product"},

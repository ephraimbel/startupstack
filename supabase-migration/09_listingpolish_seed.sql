-- ListingPolish Seed Data (idea_056)
-- AI rental listing analyzer and optimizer
...
INSERT INTO ideas (
  ...
  NULL,
  'ListingPolish',
  'Find out why your rental isn''t getting inquiries',
  'Landlords and property managers create rental listings that underperform. Bad photos, weak descriptions, missing details, and poor keyword usage mean properties sit vacant for weeks longer than necessary. They don''t know what''s wrong with their listing or how to fix it—they just see low inquiry rates.',
  'Independent landlords with 1-20 units who self-manage and create their own listings. Secondary: Small property management companies managing 20-100 units who want to improve vacancy times.',
  ...
  '$19 one-time (single analysis), $49/month (Landlord - 5 listings), $99/month (Property Manager - 25 listings), $199/month (Agency - unlimited). Free sample analysis on landing page shows value.',
  ARRAY['proptech', 'real-estate', 'ai', 'saas', 'optimization'],
  NULL,
  'validated',
  84,
  'high',
  ...
  NOW(),
  NOW(),
  'Rental market is increasingly competitive in many areas. Platforms like Zillow and Apartments.com use algorithms that reward better listings. Professional landlords are eating independent landlords'' lunch with optimized listings. AI can now analyze photos and text at scale affordably.',
  'One good analysis can save weeks of vacancy. Every week vacant costs $500-1,000. Position as ROI—''save 2 weeks vacancy time, save $2,000.'' Landlords increase listing performance and reduce time-to-rent.',
  '$30B',
  'Medium',
  'proptech',
  'b2c',
...
-- Insert landing page for ListingPolish
...
-- Insert execution plan with comprehensive ListingPolish deliverable content
    ...
    '{
      "launch_checklist": {
        ...
        "launch_day": [
          {
            "time": "8:00 AM",
            "task": "Post in BiggerPockets forums"
          },
          {
            "time": "9:00 AM",
            "task": "Reddit posts in landlord communities"
          },
          {
            "time": "10:00 AM",
            "task": "Twitter announcement"
          },
          {
            "time": "11:00 AM",
            "task": "Facebook landlord groups"
          },
          {
            "time": "12:00 PM",
            "task": "Product Hunt launch"
          },
          {
            "time": "All day",
            "task": "Respond to all comments"
          },
          {
            "time": "All day",
            "task": "Monitor for scraping/analysis failures"
          }
        ],
        "post_launch": {
          "week_1": [
